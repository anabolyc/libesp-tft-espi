...
void TFT_eSPI::fillArc(int x, int y, int start_angle, int seg_count, int rx, int ry, int w, unsigned int colour)
{
  ...
  for (int i = start_angle; i < start_angle + seg * seg_count; i += inc)
  {
    ...
    this->fillTriangle(x0, y0, x1, y1, x2, y2, colour);
    this->fillTriangle(x1, y1, x2, y2, x3, y3, colour);
